...
function showOrderPending() {
    ...
    $orders = DB::executeQuery("SELECT * FROM orders WHERE status = 'await' ORDER BY id DESC", [], false);
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Reviewed Orders</h1><br>
          </div><!-- /.col -->
